...
public class FuncoesPlanetarias implements FuncoesSistema {
	...
	public void ContarDiasTodosPlanetas(ArrayList<Planetas> planetas, ArrayList<ArrayList<Integer>> instantes, int linhas ) {
	...
	public void ContarAnosTodosPlanetas(ArrayList<Planetas> planetas,ArrayList<ArrayList<Integer>> instantes, int linhas) {
		for (int i = 0; i < planetas.size(); i++) {
